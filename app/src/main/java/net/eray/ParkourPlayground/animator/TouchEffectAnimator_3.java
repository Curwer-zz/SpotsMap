package net.eray.ParkourPlayground.animator;
 ...
 */
public class TouchEffectAnimator_3 {

    private final int EASE_ANIM_DURATION = 50;
    ...
    public TouchEffectAnimator_3(View mView) {
        this.mView = mView;
    }
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_UP) {
            ...
            ValueGeneratorAnim valueGeneratorAnim = new ValueGeneratorAnim(new InterpolatedTimeCallback() {
                ...
                public void onTimeUpdate(float interpolatedTime) {
                    ...
                    mRectAlpha = (int) (interpolatedTime * MAX_RIPPLE_ALPHA) / 3;
                    mView.invalidate();
                }
            });
