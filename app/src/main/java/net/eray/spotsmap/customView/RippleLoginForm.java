package net.eray.spotsmap.customView;
...
import net.eray.spotsmap.animator.TouchEffectAnimator_3;

/**
 * Created by Niclas on 2014-09-30.
 */
public class RippleLoginForm extends RelativeLayout {
    private TouchEffectAnimator_3 touchEffectAnimator;

    public RippleLoginForm(Context context) {
        super(context);
        init();
    }

    public RippleLoginForm(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        ...
        touchEffectAnimator.setAnimDuration(500);
